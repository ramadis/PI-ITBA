...
/*
**  Llama a funciones que retornan información sobre el estado actual del
**  tablero (Si hay espacios vacios, esta lleno o ya se llego al numero ganador)
...
/*
**  Recibe la dificultad por parámetro y retorna el número al que se debe
**	llegar para ganar, el tamaño del tablero y la cantidad de UNDOs
